          ...
          <div class="carousel-item active" style="background: url(assets/img/slide/slide-5.jpg);">
            <div class="carousel-container">
              <div class="carousel-content">
                ...
                <div>
                  <a href="#menu" class="btn-menu animate__animated animate__fadeInUp scrollto">LOGIN</a>
                  <a href="#book-a-table" class="btn-book animate__animated animate__fadeInUp scrollto">SIGN UP</a>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="col-md-6">
      <div class="jumbotron jumbotron-fluid" style="margin:20px;">
        <div class="container">
          ...
          <p>here will be text </p>
          <!-- <a href="{{url('startup-consumer')}}"> --><button onclick="document.getElementById('technician').style.display='block'" style="width:auto;" class="btn btn-button bg-warning">Create Technician Account</button><!-- </a> -->
